...
public class Login extends BasePage {
	...
	public void clicarEntrar() {
	    ...
	    public void testCadastroCliente() {
	        driver.findElement(By.cssSelector("#main-menu > :nth-child(3) > a")).click();  // Navegar até a seção "Clientes cadastro"
	        driver.findElement(By.cssSelector("[href='https://educ360dev.com.br/qa-test/admin/clientes/inserir']")).click();  // Clicar em "Novo cliente"
